...
const Rail = ({ navigationLinks }) => {
    ...
    return (
        ...
        <Divider />      <Divider /><Grid justify="center">
              <Typography className={classes.railname}>Adam Romanos<Avatar className="avatar" src='https://res.cloudinary.com/dasr4nopa/image/upload/v1640539835/IMG_0725-removebg-preview_1_ddbo1p.png' alt="Adam headshot" /></Typography>
